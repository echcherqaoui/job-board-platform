...
@Component
@Slf4j
public class ApplicationEventConsumer extends AbstractEventConsumer<ApplicationHandler> {

    public ApplicationEventConsumer(@NonNull List<ApplicationHandler> handlers) {
        super(handlers);
    }

    @KafkaListener(
          topics = "${kafka.topics.application.application-events}",
