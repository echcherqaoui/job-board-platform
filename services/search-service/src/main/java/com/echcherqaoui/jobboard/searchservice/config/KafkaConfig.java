...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, JobUpsertedEvent> jobUpsertListenerContainerFactory(DefaultErrorHandler errorHandler) {
        return buildFactory(buildConsumerFactory(JobUpsertedEvent.class), errorHandler);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, JobStatusChangedEvent> jobStatusChangedListenerContainerFactory(DefaultErrorHandler errorHandler) {
        return buildFactory(buildConsumerFactory(JobStatusChangedEvent.class), errorHandler);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, JobDeletedEvent> jobDeletedListenerContainerFactory(DefaultErrorHandler errorHandler) {
        return buildFactory(buildConsumerFactory(JobDeletedEvent.class), errorHandler);
    }
}